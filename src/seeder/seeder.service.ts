  ...
  async seed() {
    try {
      ...
      const contracts = [
        {
          type: 'ccfl',
          address: '0x0f78315aaC4F053Cf3D05999FD0A3bC3d40ab326',
          chainId: 11155111,
          asset: null,
          isActive: true,
        },
        {
          type: 'pool',
          address: '0x72C038736F191e0868A05bFD6e0a6D6DFE8c0A3C',
          chainId: 11155111,
          asset: 'USDC',
          isActive: true,
        },
        {
          type: 'pool',
          address: '0xEBE2E725ef9f2f91182886223ef5fB576AC41808',
          chainId: 11155111,
          asset: 'USDT',
          isActive: true,
        },
